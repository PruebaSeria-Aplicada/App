...
public class InsertClientWS extends AsyncTask<String, Integer, String> {

    private Context context;

    private static final String SOAP_ACTION = "http://tempuri.org/IClientService/insertClient"; //dominio más nombre método
    private static final String OPERATION_NAME = "insertClient"; //Nombre del método
    private static final String WSDL_TARGET_NAMESPACE = "http://tempuri.org/";
    public static final String SOAP_ADDRESS = "http://25.45.62.52/Services/ClientService.svc";
    Encryption encryption = new Encryption();
    private String key;

    public InsertClientWS (Context context) {
    ...
    protected void onPostExecute(String result) {
        ...
        if(!result.equalsIgnoreCase("-1")==true){
            ...
            Toast.makeText(context,"Error en el registro del cliente", Toast.LENGTH_LONG).show();
        }
